            ...
            <section>
              <div className="pr-5 flex flex-col md:flex-row items-start md:items-baseline justify-between gap-y-1 mb-2">
                ...
                <button onClick={() => {
                  ...
                  setHtmlValue(initialHtml)
                }} className="ml-[6px] bg-blue-600 font-semibold text-white text-[12px] px-2 py-[2px] boreder border-red-950 rounded-[5px]">Reset</button>
              </div>
          ...
          {cssOn && <section>
            <div className=" pr-5 flex flex-col md:flex-row items-start md:items-baseline justify-between gap-y-1 mb-2">
              ...
              <button onClick={() => {
                ...
                setCssValue('')
              }} className="ml-2 bg-blue-600 font-semibold text-white text-[12px] px-2 py-[2px] boreder border-red-950 rounded-[5px]">Reset</button>
            </div>
